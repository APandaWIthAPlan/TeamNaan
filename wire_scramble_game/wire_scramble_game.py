...
# images
BG = pygame.transform.scale(pygame.image.load('among_us_bg.png'), (HEIGHT, HEIGHT))
LIGHT = pygame.transform.scale(pygame.image.load('light.png'), (round(39*SCALE_FACTOR), round(19*SCALE_FACTOR)))

RED_END = pygame.transform.scale(pygame.transform.flip(pygame.image.load('red_end.png'), True, False), (round(88*SCALE_FACTOR), round(36*SCALE_FACTOR)))
BLUE_END = pygame.transform.scale(pygame.transform.flip(pygame.image.load('blue_end.png'), True, False), (round(88*SCALE_FACTOR), round(36*SCALE_FACTOR)))
YELLOW_END = pygame.transform.scale(pygame.transform.flip(pygame.image.load('yellow_end.png'), True, False), (round(88*SCALE_FACTOR), round(36*SCALE_FACTOR)))
GREEN_END = pygame.transform.scale(pygame.transform.flip(pygame.image.load('green_end.png'), True, False), (round(88*SCALE_FACTOR), round(36*SCALE_FACTOR)))

RED_WIRE = pygame.transform.scale(pygame.image.load('red_wire.png'), (round(88*SCALE_FACTOR), round(26*SCALE_FACTOR)))
BLUE_WIRE = pygame.transform.scale(pygame.image.load('blue_wire.png'), (round(88*SCALE_FACTOR), round(26*SCALE_FACTOR)))
YELLOW_WIRE = pygame.transform.scale(pygame.image.load('yellow_wire.png'), (round(88*SCALE_FACTOR), round(26*SCALE_FACTOR)))
GREEN_WIRE = pygame.transform.scale(pygame.image.load('green_wire.png'), (round(88*SCALE_FACTOR), round(26*SCALE_FACTOR)))


SELECTOR = pygame.transform.scale(pygame.image.load('selector.png'), (round(54*SCALE_FACTOR), round(54*SCALE_FACTOR)))
