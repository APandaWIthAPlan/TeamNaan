...
def Simon():
    ...
    #visual SimonAssets, all single images that just load over the whole screen
    WHITE = (255,255,255)
    bomb = pygame.image.load(os.path.join('SimonAssets','bomb.png'))
    bombyellow = pygame.image.load(os.path.join('SimonAssets',"bombyellow.png"))
    bombred = pygame.image.load(os.path.join('SimonAssets','bombred.png'))
    bombblue = pygame.image.load(os.path.join('SimonAssets', 'bombblue.png'))
    bombgreen = pygame.image.load(os.path.join('SimonAssets','bombgreen.png'))
    bombwin = pygame.image.load(os.path.join('SimonAssets', 'bombwin.png'))
    ...
    class Simon:
        ...
        def __init__(self):
            self.sounds = [
                Sound(os.path.join('SimonAssets',"one.wav")),
                Sound(os.path.join('SimonAssets',"two.wav")),
                Sound(os.path.join('SimonAssets',"three.wav")),
                Sound(os.path.join('SimonAssets',"four.wav")),
                Sound(os.path.join('SimonAssets',"uhoh.wav"))
            ]
